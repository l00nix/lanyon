...
5.	CM4 Heatsink with thermal compound strip and screws
6.	Customer designed 90 degree i2c OLED angle bracket
7.	Brushless LED cooling fan CPU with screws
...
{:start="8"}
8. Once Rancer was installed I connected the limcluster to it
